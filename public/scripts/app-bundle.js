  ...
  var Submit = exports.Submit = function () {
    ...
    Submit.prototype.validateInformation = function validateInformation(images) {
      ...
      if (!this.model.information.expectedPrice || this.model.information.expectedPrice === '') {
        ...
        var _regex = /^[0-9]*$/;
        if (!this.model.information.expectedPrice.match(_regex)) {
          valid = false;
          this.validation.information.expectedPrice = true;
        }
      }
