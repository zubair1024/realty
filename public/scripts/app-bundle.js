        ...
        f1 && me.validateStep(2, function (f2) {
          ...
          f2 && me.validateStep(3, function (f3) {
            ...
            if (images && images[0]) {
              ...
              switch (image.type) {
                case 'image/png':
                  filename = _this.model.loginName + '.png';
                  break;

                case 'image/jpeg':
                  filename = _this.model.loginName + '.jpg';
                  break;
              ...
              if (filename) {
                ...
                formData.append('user', _this.model.loginName);

                _this.httpclient.fetch(App.config.apiUrl + '/user/photo', {
                  method: 'POST',
                  body: formData
                  ...
                  _me.aurelia.setRoot('login/login');
