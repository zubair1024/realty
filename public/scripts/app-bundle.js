...
define('submit/submit',['exports'], function (exports) {
  ...
  var Submit = exports.Submit = function () {
    ...
    Submit.prototype.validateStep = function validateStep(step) {
      console.log(step);
