...
const sendContactMail = function (query) {
    ...
    //     from: '"The Property Buying Company" <thepropertybuyingcompanyae@gmail.com>', // sender address
    //     to: 'za@razrlab.com, jg@razrlab.com,ra@razrlab.com', // list of receivers
    //     subject: `New Contact - ${query.name}`, // Subject line
    //     text: JSON.stringify(query), // plain text body
    //     html: `<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
    //                 <!--[if IE 9 ]><html lang="en" class="ie9"><![endif]-->
    ...
    //                                         <td>
    //                                             <a href="">
    //                                                     <img src="http://res.cloudinary.com/the-property-buying-company/image/upload/v1502484922/O9IY130_tfaor8.jpg" width="650" alt="">
    //                                                 </a>
    //                                         </td>
    //                                     </tr>
    ...
    request.post({
        ...
        form: {
            "helpdesk_ticket": {
                "description_html": `<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
                <!--[if IE 9 ]><html lang="en" class="ie9"><![endif]-->
